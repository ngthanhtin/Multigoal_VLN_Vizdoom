    ...
    while True:
        ...
        for step in range(args.num_steps):
            ...
            if args.auto_encoder:
                ...
                value, logit, (hx, cx), decoder, ae_input = model((ae_input, torch.Tensor(image.unsqueeze(0)),
            ...
            (image, _, _), reward, done, (reach_1, reach_2) = env.step(action)
        ...
        if not done:
            ...
            if args.auto_encoder:
                ...
                value, _, _, decoder, ae_input = model((ae_input, torch.Tensor(image.unsqueeze(0)),
