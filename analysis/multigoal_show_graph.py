...
def plot_graph_2(graphs, labels, level='easy', shown_type='acc'):
    ...
    # plt.plot(weights2_max*points2, color = 'red', linewidth = 1, linestyle='dashed')
    # plt.plot(weights3_max*points3, color = 'green', linewidth = 1, linestyle='dashed')
    # # plot max time
    # plt.plot((times1[times1_max_index], times1[times1_max_index]), (0.15, weights1_max), color = 'blue', linestyle='dashed')
    # plt.plot((times2[times2_max_index], times2[times2_max_index]), (0.15, weights2_max), color = 'red', linestyle='dashed')
    # plt.plot((times3[times3_max_index], times3[times3_max_index]), (0.15, weights3_max), color = 'green', linestyle='dashed')
    # # plot coordinates
    # plt.text(times1[times1_max_index], weights1_max + 0.02, "(" + repr(round(weights1_max, 3)) + ", " + repr(int(times1[times1_max_index])) + ")", **text_style)
    # plt.text(times2[times2_max_index] + 1.5, weights2_max + 0.02, "(" + repr(round(weights2_max, 3)) + ", " + repr(int(times2[times2_max_index])) + ")", **text_style)
    # plt.text(times3[times3_max_index] + 6.5, weights3_max - 0.06, "(" + repr(round(weights3_max, 3)) + ", " + repr(int(times3[times3_max_index])) + ")", **text_style)
...
def plot_reaches(text_file):
    ...
    times2,_,_, reaches2 = read_file(text_file="./saved/fourier_models/two_goals/easy/train_easy_multigoal_fourier_d1_gated.log")
